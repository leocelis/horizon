...
*Generated 2026-04-22 · closes the loop from research → working product.*

This document is the single source of truth for whether the Horizon Fidelity
Monitor is finished. Every claim links to a file you can open and verify.
...
```
Research essay  ──▶  horizon_intent.yaml  ──▶  HORIZON_TECH_SPEC.md  ──▶  src/horizon/  ──▶  tests/
  (why)               (what)                    (how)                       (code)          (proof)
```

| Stage | Document | Purpose |
|---|---|---|
| Research | [`TRANS_HORIZON_COMMUNICATION_HUMAN_AI_THEORETICAL_FRAMEWORK.md`](../research/TRANS_HORIZON_COMMUNICATION_HUMAN_AI_THEORETICAL_FRAMEWORK.md) | 4D spacetime framework, 13 conjectures, 173 refs. |
| PRD | [`THCP_FIDELITY_MONITOR_PRD.md`](../product/THCP_FIDELITY_MONITOR_PRD.md) | Product requirements. |
...
Passing                   : 152
Skipped                   :   5   (validation gates V1/V2/V3/V5 — awaiting labeled data, by design)
Failing / errors          :   0
Runtime (full suite, CPU) : ~6 min
```

| Bucket | Count | Path |
|---|---:|---|
| Unit | 116 | [`tests/unit/`](../../tests/unit/) |
| End-to-end (framework integrations) | 20 | [`tests/e2e/`](../../tests/e2e/) |
| Integration | 12 | [`tests/integration/`](../../tests/integration/) |
| Validation gates (V1/V2/V3/V5) | 5 | [`tests/validation/`](../../tests/validation/) |
| Performance | 4 | [`tests/perf/`](../../tests/perf/) |
...
All 5 priority-1 gates auto-skip until you provide a labeled validation dataset
(pointed to by `HORIZON_VALIDATION_DATA` env var). That's the contract
