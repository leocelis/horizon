...
├── docs-private/       # Non-public docs (git-ignored; e.g. market research)
...
Validation gates in `tests/validation/` auto-skip unless the
`HORIZON_VALIDATION_DATA` environment variable points to a labeled dataset.
