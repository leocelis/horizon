...
# Feeds the Horizon tenant audit trail (live badge + trust page).
#
...
PROBE_TEXT="${COMPLYEDGE_RUNTIME_PROBE_TEXT:-Horizon runtime compliance probe — EU check on representative LLM-facing artifact text.}"
