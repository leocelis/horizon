...
| "39% accuracy degradation after 5 turns" | Third-party market research cited in `docs/research/market-demand.md` | General pattern across multiple external studies; see market-demand.md for citations | Horizon did not conduct this research; cite original sources for compliance purposes |
...
The THCP theoretical framework (`docs/research/TRANS_HORIZON_COMMUNICATION_HUMAN_AI_THEORETICAL_FRAMEWORK.md`)
cites 173 academic references and three no-go theorems. All citations represent the
authors' characterization of those works at the time of writing and have not been
